...
namespace margelo::nitro::margeloContact {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PhoneNumber).
   */
  struct PhoneNumber {
  public:
  ...
  public:
    explicit PhoneNumber(std::optional<std::string> label, std::string value): label(label), value(value) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ PhoneNumber <> JS PhoneNumber (object)
  template <>
  struct JSIConverter<PhoneNumber> {
    static inline PhoneNumber fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const PhoneNumber& arg) {
