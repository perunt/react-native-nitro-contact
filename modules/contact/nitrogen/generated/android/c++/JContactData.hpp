...
namespace margelo::nitro::margeloContact {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/margeloContact/ContactData;";
  ...
  public:
    ...
    ContactData toCpp() const {
      ...
      static const auto fieldPhoneNumbers = clazz->getField<jni::JArrayClass<jni::JString>>("phoneNumbers");
      jni::local_ref<jni::JArrayClass<jni::JString>> phoneNumbers = this->getFieldValue(fieldPhoneNumbers);
      static const auto fieldEmailAddresses = clazz->getField<jni::JArrayClass<jni::JString>>("emailAddresses");
      jni::local_ref<jni::JArrayClass<jni::JString>> emailAddresses = this->getFieldValue(fieldEmailAddresses);
